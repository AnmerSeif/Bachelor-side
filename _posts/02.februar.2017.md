{{{
    "title" : "Møte med detaljhandelselskapet, Godt i gang med kode!",
    "date" : "02-02-2017",
    "preview": " %/img/blog/template.png; Da har vi snakket med et detaljhandelselskap og fikk sett på deres løsning :)"
    }}}

<img src="/img/blog/template.png" width="100%" />

</br>
## Møte med Detaljhandelselskapet
</br>
I dag var vi på møte med sjefen for kundesevice for detaljhandelselskapet. Vi fikk mye informasjon om hvilken verdi chat-systemet har for dem, hva som er den viktigste funksjonaliteten og hvordan de ønsker å utvikle sin kundeservice. Vi fikk i tillegg sett på deres løsning.

</br>
## Godt i gang med kode
</br>
Mye ble gjort i dag. I tilegg til møte med detaljhandelselskapet så har vi endelig startet
