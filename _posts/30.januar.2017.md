{{{
    ...
    "date" : "01-30-2017",
    "preview": " %/img/blog/template.png; Adam har brukt dagen til å kontakte og kommunisere med en mengde bedrifter."
    }}}
...
Det vil ikke være ofte at mann henter informasjon fra databasne men når det først bli hentet så er det en del utregniner og kombinasjoner som må bli utføret på tallene før de bli presentert. En ny spørsmål dukker da. Kan vi ha en tabell som inneholder en sammensetning av statistikken som vi vet vil ikke endres og vil effektivisere spørringene?  
