...
For å kunne teste diverse backend funksjoner så måtte vi ha en protype av chat appen. Derfor brukte vi en stor del av dagen på å kode en alpha versjon. Overraskende nok så ble vi fort ferdig og møtte ikke på noe problemer under utviklingen. Vi hadde ikke akkurat den mest organiserte og struktuerte koden, men den gjorde jobben sin.
